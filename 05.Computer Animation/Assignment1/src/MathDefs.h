...
void	ScaleVector(const tVector *v, float scale, tVector *result);
void	VectorSum(const tVector *v1, const tVector *v2, tVector *result);
void	VectorDifference(const tVector *v1, const tVector *v2, tVector *result);
