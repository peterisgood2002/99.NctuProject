...
public class MCutMFlowGraphic implements Graphic{
	...
	private Vector< HashMap< Integer ,Edge> > viedges;//Vertex的inner edge
	private Vector< HashMap< Integer ,Edge> > voedges;//outer edge
...
//		}
	...
	private HashMap< Integer ,Edge> getOuterEdge( Vertex node ) {
		try {
	...
	private HashMap< Integer ,Edge> getInnerEdge( Vertex node) {
		try {
